...
public class AccommodationController {
	...
	public ResponseEntity<Accommodation> getAccommodation(@PathVariable("email") Long email) {
		Accommodation accommodation = accommodationService.findOne(email);
	...
	public ResponseEntity<Accommodation> updateAccommodation(@RequestBody Accommodation accommodation, @PathVariable Long email)
			throws Exception {
		Accommodation accommodationForUpdate = accommodationService.findOne(email);
	...
	public ResponseEntity<Accommodation> deleteAccommodation(@PathVariable("email") Long email) {
		accommodationService.delete(email);
